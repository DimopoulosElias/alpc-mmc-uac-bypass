...
static const SERVER_ROUTINE DefaultIfName_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Proc0_RAiLaunchAdminProcess,
    (SERVER_ROUTINE)Proc1_RAiProcessRunOnce,
    (SERVER_ROUTINE)Proc2_RAiLogonWithSmartCardCreds,
    (SERVER_ROUTINE)Proc3_RAiOverrideDesktopPromptPolicy,
    (SERVER_ROUTINE)Proc4_RAiDisableElevationForSession,
    (SERVER_ROUTINE)Proc5_RAiEnableElevationForSession,
    (SERVER_ROUTINE)Proc6_RAiForceElevationPromptForCOM
    };
