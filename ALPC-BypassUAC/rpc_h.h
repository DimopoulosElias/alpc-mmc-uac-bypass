...
long Proc0_RAiLaunchAdminProcess( 
...
long Proc1_RAiProcessRunOnce( 
    /* [in] */ handle_t IDL_handle,
    /* [string][in] */ wchar_t *arg_1,
    /* [out] */ struct Struct_56_t *arg_2);

long Proc2_RAiLogonWithSmartCardCreds( 
    /* [in] */ handle_t IDL_handle,
    /* [in] */ long arg_2,
    /* [string][in] */ wchar_t *arg_3,
    /* [in] */ unsigned __int3264 arg_4);

long Proc3_RAiOverrideDesktopPromptPolicy( 
    /* [in] */ handle_t IDL_handle);

long Proc4_RAiDisableElevationForSession( 
    /* [in] */ handle_t IDL_handle,
    /* [in] */ long arg_1);

long Proc5_RAiEnableElevationForSession( 
    /* [in] */ handle_t IDL_handle,
    /* [in] */ long arg_1);

long Proc6_RAiForceElevationPromptForCOM( 
    /* [in] */ handle_t IDL_handle,
    ...
    /* [in] */ long arg_5,
    /* [string][in] */ wchar_t *arg_6,
    /* [in] */ struct Struct_84_t *arg_7,
    /* [string][in] */ wchar_t *arg_8,
    /* [string][in] */ wchar_t *arg_9,
    /* [string][in] */ wchar_t *arg_10,
    /* [string][in] */ wchar_t *arg_11,
    /* [in] */ long arg_12);
